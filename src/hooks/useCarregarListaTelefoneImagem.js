...
const useCarregarListaTelefoneImagem = ()=>{
...
return {telefones, setTelefones, enviados, naoEnviados, carregandoLista, erroLista, carregarTelefones, setEnviados, setNaoEnviados}
};

export default useCarregarListaTelefoneImagem;
